import { Component, ViewChild, ElementRef, HostListener, Renderer2, OnInit, OnDestroy } from '@angular/core';

@Component({
  selector: 'app-lawwithnumbers',
  templateUrl: './lawwithnumbers.component.html',
  styleUrls: ['./lawwithnumbers.component.scss']
})
export class LawwithnumbersComponent implements OnInit, OnDestroy {
